...
module.exports = async (req, res) => {
  ...
  const prompt =
    `Search the web for the very latest news about "${query}" published in the past 2 weeks. ` +
    `Find a specific recent story — a funding round, product launch, partnership, milestone, or major announcement. ` +
    `Return ONLY a single valid JSON object, no markdown, no code fences, no text before or after the JSON. ` +
    `Keys: {"headline":"one specific factual headline","summary":"2-3 investor-focused sentences with concrete details","date":"e.g. Mar 14 2026","source":"Publication Name","url":"direct article URL or # if none"}`;
